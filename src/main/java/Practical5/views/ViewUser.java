package Practical5.views;

import Practical5.controllers.UserController;
import Practical5.model.User;
import Practical5.views.validator.NameAndSurnameValidator;
...
public class ViewUser {
    ...
    private void deleteUser() throws Exception {
        readList();
        String user = getUserIDString();
        User deleteOneUser = userController.deleteUser(user);
    ...
    private String getUserIDString() throws Exception {
        String id = prompt("Идентификатор пользователя: ");
        return id;
    }
